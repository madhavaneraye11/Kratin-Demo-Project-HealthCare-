...
public class DataSource
{
  ...
  private static final com.spam.maddy.kratindemoproject.DataSource mDataSource = new com.spam.maddy.kratindemoproject.DataSource();
  ...
  public static synchronized com.spam.maddy.kratindemoproject.DataSource getInstance(Context context)
  {
    if (mContext == null)
    {
