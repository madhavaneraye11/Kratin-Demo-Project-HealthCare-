...
public class NearByGymActivity extends FragmentActivity implements GoogleApiClient.ConnectionCallbacks,
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        ...
                        try {
                            ...
                            status.startResolutionForResult(NearByGymActivity.this, 1);
    ...
    private boolean isGooglePlayServicesAvailable() {
        ...
        if (ConnectionResult.SUCCESS == status) {
            ...
            GooglePlayServicesUtil.getErrorDialog(status, NearByGymActivity.this, 0).show();
            return false;
        }
    }
    ...
    public void conlist() {
        ...
        GooglePlacesReadTask googlePlacesReadTask = new GooglePlacesReadTask(NearByGymActivity.this);
    ...
    public void onConnectionFailed(ConnectionResult connectionResult) {
        ...
        if (connectionResult.hasResolution()) {
            try {
                ...
                connectionResult.startResolutionForResult(NearByGymActivity.this, CONNECTION_FAILURE_RESOLUTION_REQUEST);
                /*
