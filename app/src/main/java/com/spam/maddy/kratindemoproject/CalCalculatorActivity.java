...
import com.spam.maddy.kratindemoproject.entities.Day;
...
import com.spam.maddy.kratindemoproject.utils.MyDate;
...
public class CalCalculatorActivity extends AppCompatActivity {
    Profile profile;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Calories Calculator Dashboard");
    ...
    DatePickerDialog.OnDateSetListener myCallBack = new DatePickerDialog.OnDateSetListener() {
        ...
        public void onDateSet(DatePicker view, int year, int monthOfYear,
            ...
            try {
                ...
                Toast.makeText(CalCalculatorActivity.this, getString(R.string.invalid_date), Toast.LENGTH_SHORT).show();
            } catch (NullPointerException e) {
                Toast.makeText(CalCalculatorActivity.this, getString(R.string.invalid_year), Toast.LENGTH_SHORT).show();
            }
        }
    };
