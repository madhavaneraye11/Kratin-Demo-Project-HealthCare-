...
public class AddDrAlarm extends AppCompatActivity {
    ...
    {
        if (Alarm.ONCE == mAlarm.getOccurence())
            Toast.makeText(AddDrAlarm.this,""+mDateTime.formatDate(mAlarm),LENGTH_SHORT).show();
           // mDateButton.setText(mDateTime.formatDate(mAlarm));
        else if (Alarm.WEEKLY == mAlarm.getOccurence())
            //mDateButton.setText(mDateTime.formatDays(mAlarm));
            Toast.makeText(AddDrAlarm.this,""+mDateTime.formatDays(mAlarm),LENGTH_SHORT).show();

        Toast.makeText(AddDrAlarm.this,""+mDateTime.formatTime(mAlarm),LENGTH_SHORT).show();
