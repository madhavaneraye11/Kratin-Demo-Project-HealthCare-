package com.spam.maddy.kratindemoproject.preferences;

import android.app.Activity;
import android.content.Context;
import android.content.SharedPreferences;

import com.spam.maddy.kratindemoproject.CalProfileActivity;
...
public class Profile {
    ...
    public void setGender(Activity activity, boolean gender) {
        if (activity instanceof CalProfileActivity) {
            this.gender = gender;
        }
    }
